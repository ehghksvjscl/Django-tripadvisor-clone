    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenity', models.ManyToManyField(through='hotels.HotelAmenity', to='hotels.Amenity')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='hotel_detail',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotels.HotelDetail'),
        ),
        migrations.CreateModel(
            name='Hotel',
            fields=[
